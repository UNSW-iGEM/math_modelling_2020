# Copied from https://github.com/pysb/pysb/blob/b19d85dc16666a50c8119cdd53183acfd9eea87d/pysb/tools/species_graph.py
# Modified to allow us to change a number of graphviz options
...
def run(model, include_rate_species=False):
    ...
    graph = pygraphviz.AGraph(directed=True, rankdir="LR", strict=strict, overlap=False)
